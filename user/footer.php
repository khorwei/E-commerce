...
<footer>
    ...
    <a href="contact_us.php" target="_self" class="contact-site">CONTACT US !</a>
    </h3>
    ...
    <div class="footer-container">
        ...
        <div class="share-image">
            <p class="pfooter">
                <img src="../images/email.png" alt="Email Us!"  id="social">
                Email: &emsp;&emsp;&nbsp;
    ...
    <small class="copyright">
        <i style="color: white; text-align: center;">Copyright &copy Second Libros</i>
    </small>
